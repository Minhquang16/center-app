...
export default function AttendancePage() {
  ...
  const handleCheckin = async (e) => {
    ...
    try {
      ...
      setErrorMsg(
        err.response?.data?.message || "Không tìm thấy thông tin học sinh!",
      );
      toast.error(
        err.response?.data?.message || "Không tìm thấy thông tin học sinh!",
      );
  ...
  return (
    <div
      className="space-y-6 text-slate-800 dark:text-slate-200 dark:text-slate-200 pb-12"
            ...
            <div className="mb-6 space-y-4">
              ...
              <div>
                ...
                >
                  {isWeekend ? (
                    <>
                      <option value="Ca 1 (08:00 - 09:30)">
                        Ca 1 (08:00 - 09:30)
                      </option>
                      <option value="Ca 2 (09:45 - 11:15)">
                        Ca 2 (09:45 - 11:15)
                      </option>
                      <option value="Ca 3 (14:00 - 15:30)">
                        Ca 3 (14:00 - 15:30)
                      </option>
                      <option value="Ca 4 (15:45 - 17:15)">
                        Ca 4 (15:45 - 17:15)
                      </option>
                      <option value="Ca 5 (18:00 - 19:30)">
                        Ca 5 (18:00 - 19:30)
                      </option>
                      <option value="Ca 6 (19:45 - 21:15)">
                        Ca 6 (19:45 - 21:15)
                      </option>
                    </>
                  ) : (
                    <>
                      <option value="Ca 1 (17:30 - 19:00)">
                        Ca 1 (17:30 - 19:00)
                      </option>
                      <option value="Ca 2 (19:00 - 20:30)">
                        Ca 2 (19:00 - 20:30)
                      </option>
                      <option value="Ca 3 (20:30 - 22:00)">
                        Ca 3 (20:30 - 22:00)
                      </option>
                    </>
                  )}
            ...
            {lastCheckin && (
              <div className="p-4 bg-emerald-50 dark:bg-emerald-900/30 dark:bg-emerald-900/30 border border-emerald-200 rounded-xl text-emerald-900 space-y-2 animate-in fade-in zoom-in duration-200">
                <div className="flex items-center space-x-3 border-b border-emerald-200/60 pb-2">
                  ...
                  <div>
                    <span className="text-[10px] font-bold uppercase tracking-wider text-emerald-700 dark:text-emerald-400 dark:text-emerald-400">
                      ĐIỂM DANH THÀNH CÔNG
                    </span>
                    <p className="font-extrabold text-base text-slate-900 dark:text-white">
                      {lastCheckin.student?.full_name}
                    </p>
                  </div>
                </div>
                ...
                <div className="text-xs space-y-1 pt-1 text-slate-700 dark:text-slate-300 dark:text-slate-300">
                  <p>
                    ...
                    <b className="font-mono text-slate-900 dark:text-white">
                      {lastCheckin.student?.student_code}
                    </b>
                  </p>
                  <p>
                    • Khối / Lớp:{" "}
                    <b>
                      Khối {lastCheckin.student?.grade}{" "}
                      {lastCheckin.student?.class_type &&
                        `(${lastCheckin.student.class_type})`}
                    </b>
                  </p>
                  <p>
                    ...
                    <b className="font-mono">
                      {lastCheckin.student?.parent_phone}
                    </b>
                  </p>
                  <p>
                    • Thời gian vào lớp:{" "}
                    <b className="text-emerald-700 dark:text-emerald-400 dark:text-emerald-400 font-mono">
                      {lastCheckin.time}
                    </b>
                  </p>
                </div>
              ...
              {filteredLogs.length === 0 ? (
                <div className="p-8 text-center text-slate-400 italic text-sm">
                  {logSearch
                    ...
                    : "Chưa có lượt điểm danh nào hôm nay."}
                </div>
              ) : (
                filteredLogs.map((log, index) => (
                  <div
                    key={log.id}
                    className="p-4 bg-slate-50 dark:bg-slate-900/30 hover:bg-slate-100 dark:hover:bg-slate-800/50 transition-colors space-y-2"
                  >
                  ...
                  {filteredLogs.length === 0 ? (
                    ...
                    filteredLogs.map((log, index) => (
                      ...
                      >
                        ...
                        <td className="p-3 font-bold text-slate-700 dark:text-slate-300 dark:text-slate-300 whitespace-nowrap">
                          {log.student?.student_code}
                        </td>
                        ...
                        <td className="p-3 font-mono text-slate-600 dark:text-slate-400 dark:text-slate-400 whitespace-nowrap">
                          {log.student?.parent_phone}
                        </td>
