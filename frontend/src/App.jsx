...
const UserRoleManagement = React.lazy(
  () => import("./pages/UserRoleManagement"),
);
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-100 dark:bg-slate-900 transition-colors duration-300">
        <img
          src="/logo.png"
          alt="Sunny Logo"
          className="h-24 mb-6 animate-pulse object-contain drop-shadow-lg"
        />
        <p className="text-cyan-700 dark:text-cyan-400 font-bold animate-pulse text-lg tracking-wide">
